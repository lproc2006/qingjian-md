<p align="center">
  <img src="assets/icon.png" width="132" height="132" alt="清笺MD图标">
</p>
...
左侧编辑 Markdown，右侧即时呈现最终结果。无论滚动编辑区还是预览区，另一侧都会按文档进度同步移动；两侧共用显示比例和基准字号，长文对照更自然。编辑中的回车次数和连续空行也会在预览中原样保留。
