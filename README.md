<p align="center">
  <img src="assets/icon.png" width="144" height="144" alt="清笺MD图标">
</p>

<h1 align="center">清笺MD</h1>

<p align="center"><strong>为 Mac 而生的原生 MD 编辑器</strong></p>

<p align="center">双击即开 · 实时分屏 · 自动保存 · PDF / DOCX 导出</p>
...
预览、编辑、分屏三种模式一键切换。分屏时左侧写 Markdown，右侧即时显示最终效果，并保持阅读位置联动；修改不需要等待刷新。

### 写作需要的格式，一处就够

内置标题、加粗、斜体、删除线、列表、任务清单、引用、代码、链接、图片、表格和脚注。选择文字后会出现可移动的快捷格式条，连续修改同类格式时会自动替换旧格式。
